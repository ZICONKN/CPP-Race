...
void Credit()
{
    gotoxy(BATAS_KANAN + 5, 4); cout << "KONTROL";
    gotoxy(BATAS_KANAN + 5, 5); cout << "W : ATAS ";
    gotoxy(BATAS_KANAN + 5, 6); cout << "S : BAWAH";
    gotoxy(BATAS_KANAN + 5, 7); cout << "D : KANAN";
    gotoxy(BATAS_KANAN + 5, 8); cout << "A : KIRI";
    gotoxy(BATAS_KANAN + 5, 10); cout << "JEDA";
    gotoxy(BATAS_KANAN + 5, 11); cout << "KLIK MOUSE MANA AJA";
    gotoxy(BATAS_KANAN + 5, 13); cout << "LANJUT";
...
int main()
{
    ...
    tulisTengah("==========================================", 12);
    tulisTengah("MASUKKAN TINGKAT KECEPATAN [MASUKKAN ANGKA]", 14);
    tulisTengah("INTINYA SEMAKIN BESAR SEMAKIN LAMBAT HEHEHE", 16);
    ...
    spk -= iJarak / 200;
    system("cls");
    gotoxy(20, 12); cout << "SKOR ANDA : " << (iJarak / spk) + pemainUtama.darah * 100;
    gotoxy(20, 13); cout << "TOTAL WAKTU : " << (clock() - before) / 1000 << " DETIK";
    tulisTengah("=========================================", 15);
    tulisTengah("MENDING KERJA", 17);
    tulisTengah("=========================================", 19);
    tidur(5000);
    getch();
